...
//  * 
//  * DISCLAIMER: This is a modified version of ulid nodejs library to handle some errors causing from the original library
//  * 
//  * Attribution:
//  * @author Alizain Feerasta<alizain>
//  * @license MIT
//  * Original code repo: https://github.com/ulid/javascript/
//  * This has some minor fixes
//  * - removed the import of crypto as it's builtin
//  */
...
//         const t: number = typeof seedTime === "number" ? seedTime : Date.now()
//         return encodeTime(t, TIME_LEN) + encodeRandom(RANDOM_LEN, currPrng)
//     }
// }
...
//     return function ulid(seedTime?: number): string {
//         const ensuredSeedTime: number = typeof seedTime === "number" ? seedTime : Date.now()

//         // if (isNaN(seedTime)) {
//         //     seedTime = Date.now()
//         // }

//         if (ensuredSeedTime <= lastTime) {
//             const incrementedRandom = (lastRandom = incrementBase32(lastRandom))
//             return encodeTime(lastTime, TIME_LEN) + incrementedRandom
//         }
//         lastTime = ensuredSeedTime
//         const newRandom = (lastRandom = encodeRandom(RANDOM_LEN, currPrng))
//         return encodeTime(ensuredSeedTime, TIME_LEN) + newRandom
//     }
// }
