<script>
    ...
    const depServiceStatus =
        data?.dependenciesStatus?.secondary_redis == "true";
    const systemServiceStatus = data?.systemServiceStatus?.redwiz == "true";

    const depServiceName = "Secondary_Redis";
    const systemServiceName = "Redwiz";
</script>
