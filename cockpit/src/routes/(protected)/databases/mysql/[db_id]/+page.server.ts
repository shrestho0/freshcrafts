...
export const actions: Actions = {
    ...
    update: async ({ params, request }) => {
        ...
        const { newDBName, newDBUser, newUserPassword } = Object.fromEntries(await request.formData()) as {
            newDBName: string,
            newDBUser: string,
        ...
        console.warn("[DEBUG]: databases/mysql/[db_id] update", JSON.stringify({ db_id, newDBName, newDBUser, newUserPassword }, null, 2));
