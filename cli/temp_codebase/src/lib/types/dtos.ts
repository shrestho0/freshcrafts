import type { DBMongo, DBMysql, DBPostgres, DBRedis } from "./entities";
...
export type EngineRedisDBGetOneError = {};
...
export type EngineMongoDBCreatePayload = DBMongo;
export type EngineRedisCreatePayload = DBRedis;
...
export type EngineRedisCreateError = { dbPrefix: string; username: string; password: string; };
...
export type EngineRedisUpdateError = { password: string };
