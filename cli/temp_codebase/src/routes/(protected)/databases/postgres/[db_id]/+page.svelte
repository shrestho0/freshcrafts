						...
						{#if connectionOptions.selectedIdx == 0}
							<div>
								<CodeSnippet
									type="multi"
									light={true}
									code={generatePostgreSQLShellCode(
										data.payload,
						...
						{:else if connectionOptions.selectedIdx == 1}
							<div>
								<CodeSnippet
									...
									light={true}
									showMoreLess={false}
									code={generatePostgreSQLConnUrl(
										data.payload,
										connectionOptions.remote_or_local ===
											"remote",
									)}
						...
						{:else if connectionOptions.selectedIdx == 3}
							<div class="flex flex-col gap-2 py-2">
								...
								<CodeSnippet
									light={true}
									type="single"
									code={getPostgreSQLConnectionHost(
										connectionOptions.remote_or_local ===
											"remote",
									)}
								></CodeSnippet>
								...
								<CodeSnippet
									light={true}
									type="single"
									code={getPostgreSQLConnectionPort(
										connectionOptions.remote_or_local ===
											"remote",
									)}
								></CodeSnippet>
